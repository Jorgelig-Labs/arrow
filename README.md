...
> Phases 0 (parser/CLI), 1 (web UI) and 2 (packaging) are complete; since then: 24 parser tests, a
...
logic; the same source of truth for terminal, web, and native app. The parser ships **24 unit tests**
